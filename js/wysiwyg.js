...
(function() {
  ...
  Wysiwyg = (function() {
    ...
    Wysiwyg.prototype.render = function() {
      ...
      this.el.append('<a href="#" data-type="h1">Pealkiri</a>');
      this.el.append('<a href="#" data-type="h2">Alapealkiri</a>');
      return this;
    };
    ...
    Wysiwyg.prototype.h1 = function(e) {
      e.preventDefault();
      if (this.query('formatBlock') === 'h1') {
